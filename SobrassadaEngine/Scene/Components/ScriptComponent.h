...
class ScriptComponent : public Component
{
  ...
  private:
    ...
    std::vector<std::string> scripts = {
        "RotateGameObject",       "ButtonScript",      "GodMode",         "ExitGameScript",
        "FullscreenToggleScript", "VSyncToggleScript", "PauseMenuScript", "OptionsMenuSwitcherScript",
        "MainMenuSelectorScript", "PressAnyKeyScript"
    };
