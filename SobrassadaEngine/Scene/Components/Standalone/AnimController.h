...
class AnimController
{
  public:
    ...
    void GetTransform(const std::string& nodeName, float3& pos, Quat& rot, float3& scale);
  ...
  private:
    ...
    void GetChannelScale(const Channel* animChannel, float3& scale, const float time) const;
